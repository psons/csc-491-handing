...
import Foundation
var effortDomainTestJsonString =
    """
    {
...
"""
let slotStateData = slotStateJsonString.data(using: .utf8)!
let slotState: SlotState = try! JSONDecoder().decode(SlotState.self, from: slotStateData)
